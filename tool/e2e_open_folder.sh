...
# outside it is added to the library and shown, a folder of page images
# and a CBZ open in the reader. Checks the library folders with sqlite3
...
# 3. A folder of page images is a book; so is a CBZ.
start "$comics/Pepper&Carrot/pepper-carrot-e06"; shot 05_folder_book_reads
stop
start "$comics/Golden Age/weird-comics-004.cbz";  shot 06_cbz_reads
stop
check "no folder added for a book" "$(sql 'select count(*) from roots')" 2
