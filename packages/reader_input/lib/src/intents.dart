...
enum ReaderIntent {
  ...
  regionUpperHalf('Upper half of the page, enlarged; l and h step to the other half, then on; again or Esc for the whole page'),
  regionLowerHalf('Lower half of the page, enlarged'),
  regionUpperThird('Upper third of the page, enlarged; l and h step through the thirds, then on; again or Esc for the whole page'),
  regionMiddleThird('Middle third of the page, enlarged'),
  regionLowerThird('Lower third of the page, enlarged'),
  regionTopLeft('Top-left quarter of the page, enlarged; l and h step through the quarters in reading order, then on; again or Esc for the whole page'),
